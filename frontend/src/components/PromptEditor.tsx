...
const DEFAULT = `You are a helpful voice assistant. Your responses will be spoken aloud, so keep them concise and natural. When knowledge base context is provided, use it to give accurate, specific answers.`;
